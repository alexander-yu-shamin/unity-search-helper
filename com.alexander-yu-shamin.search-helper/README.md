...
![search-helper-dynamic](Documentation~/images/search-helper-dynamic.gif)

### Ignore Rules
![search-helper-filter-rule](Documentation~/images/search-helper-filter-rule.png)
...
### Missing Tool
![search-helper-missing-tool](Documentation~/images/search-helper-missing-tool.png)

The tool can locate objects with missing references.

### Find By GUID Tool
![search-helper-find-by-guid](Documentation~/images/search-helper-find-by-guid.png)
